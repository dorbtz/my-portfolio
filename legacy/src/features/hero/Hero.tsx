...
import { useMode, useMotionOn, useEffectsActive, useModeStore } from '../../shared/stores/mode';
import { useCapability } from '../../shared/hooks/useCapability';
import { useViewTransitionNav } from '../../shared/lib/navigate';
import { listProjects } from '../projects/services/projects';
import { filterProjectsByMode, getFixturesForMode } from '../projects/data/project-fixtures';
import { playSfx, stopSfx } from '../../shared/lib/audio';
import { gsap } from '../effects/lib/gsap';
import { useSiteContent } from '../content/hooks/useSiteContent';
import { PORTFOLIO } from '../../shared/lib/portfolioConfig';
