...
import { useModeStore, useMode, useSoundOn, useMotionOn, useEffectsActive } from '../../shared/stores/mode';
import { playSfx, stopSfx, setAudioMuted } from '../../shared/lib/audio';
...
import {
  ...
  type SecretState,
  type SecretConfig,
} from '../auth/lib/secretAdminEntry';
