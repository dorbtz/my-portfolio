    ...
    <Section id="contact" ariaLabel="Contact">
      <div className="grid gap-6 lg:grid-cols-5">
        <AppleSpring kind="fade-up" className="lg:col-span-2">
          <p className="text-caption uppercase tracking-[0.18em] text-accent">{CONTACT.eyebrow}</p>
          <h2 className="text-h1 font-bold mt-2">{CONTACT.title}</h2>
          <p className="text-body text-muted mt-3">{CONTACT.body}</p>
          <p className="text-body-sm text-muted mt-6">{CONTACT.emailLabel}</p>
          <a
