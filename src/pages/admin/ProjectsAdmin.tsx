...
import { useMode, type Mode } from "../../stores/mode";
import {
  AdminCheckbox,
  AdminField,
  AdminInput,
...
import AdminTopBar from "../../features/admin-dashboard/admin/AdminTopBar";
import AdminPageIcon from "../../features/admin-dashboard/admin/AdminPageIcon";
import "../../features/admin-dashboard/styles/admin-dashboard.css";
import { DossierCard } from "./DossierCard";
import { useContentEditor } from "../../features/content/admin/useContentEditor";
import InlineEdit from "../../features/content/admin/InlineEdit";
import RotatingListEditor from "../../features/content/admin/RotatingListEditor";
